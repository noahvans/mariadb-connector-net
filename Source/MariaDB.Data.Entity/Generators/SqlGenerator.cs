...
{
    internal abstract class SqlGenerator : DbExpressionVisitor<SqlFragment>
    {
        ...
        #endregion DbExpressionVisitor Base Implementations
        ...
        #endregion DBExpressionVisitor methods normally overridden
        ...
        private SqlFragment VisitBinaryExpression(DbExpression left, DbExpression right, string op)
        {
