...
namespace MariaDB.Data.MySqlClient.Tests
{
	...
	public class PreparedStatements : BaseTest
	{
		...
		public void Bug6271()
		{
			...
			cmd.Parameters.AddWithValue("?desc", "Ceci est une description facile ?plantouiller");
			...
			using (MySqlDataReader reader = cmd.ExecuteReader())
			{
				...
				Assert.AreEqual("Ceci est une description facile ?plantouiller", reader.GetString(2));
